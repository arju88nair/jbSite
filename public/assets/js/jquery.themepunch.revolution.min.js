...
(function (e, t) {
    ...
    function v(e, n) {
        ...
        if (e.data("orgw") != t && e.data("orgw") != 0) {
            e.width(e.data("orgw"));
    ...
    function x(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            var m = f.find(".slotslide");
            if (l == 12)if (r.ie9) {
                m.transition({left: d + "px"}, 0)
            } else {
                m.transition({left: d + "px", rotate: r.rotate}, 0)
            } else if (l == 15)if (r.ie9) m.transition({left: 0 - r.width + "px"}, 0); else m.transition({
                left: 0 - r.width + "px",
                rotate: r.rotate
            }, 0); else if (l == 13)if (r.ie9) m.transition({top: v + "px"}, 0); else m.transition({
                top: v + "px",
                rotate: r.rotate
            }, 0); else if (l == 14)if (r.ie9) m.transition({top: 0 - r.height + "px"}, 0); else m.transition({
                top: 0 - r.height + "px",
                rotate: r.rotate
            }, 0);
            m.transition({left: "0px", top: "0px", opacity: 1, rotate: 0}, h, function () {
                w(n, r, 0);
                if (o.index() != i.index()) u.find(".defaultimg").css({opacity: 0});
                f.find(".defaultimg").css({opacity: 1});
                r.act = r.next;
    ...
    function O(n, r, i) {
        ...
        n.find(".tp-caption").each(function (i) {
            ...
            if (f == 0) {
                        ...
                        if (n.attr("src").toLowerCase().indexOf("youtube") >= 0) {
                            if (!n.hasClass("HasListener")) {
                                try {
                                    ...
                                    }); else r = new YT.Player(c, {events: {onStateChange: N}});
                            ...
                            if (n.attr("src").toLowerCase().indexOf("vimeo") >= 0) {
                                if (!n.hasClass("HasListener")) {
                                    ...
                                    if (a.data("autoplay") == true) $f(r).addEvent("ready", A); else $f(r).addEvent("ready", L)
                                } else {
                                    if (a.data("autoplay") == true) {
                                        var n = a.find("iframe");
                                        var h = n.attr("id");
                ...
                var w = a.data("voffset") * o;
                var E = a.data("hoffset") * o;
                if (a.data("x") == "center" || a.data("xcenter") == "center") {
                    a.data("xcenter", "center");
                    a.data("x", (r.width / 2 - a.outerWidth(true) / 2) / o - s + E)
                }
                ...
                if (a.data("x") == "right" || a.data("xright") == "right") {
                    a.data("xright", "right");
                    a.data("x", (r.width - a.outerWidth(true)) / o - s + E)
                }
                if (a.data("y") == "center" || a.data("ycenter") == "center") {
                    a.data("ycenter", "center");
                    a.data("y", (r.height / 2 - a.outerHeight(true) / 2) / r.bh + w)
                }
                ...
                if (a.data("y") == "bottom" || a.data("ybottom") == "bottom") {
                    ...
                    a.data("y", (r.height - a.outerHeight(true)) / r.bh + w)
                }
                if (a.hasClass("fade")) {
                ...
                if (a.hasClass("randomrotate")) {
                    ...
                    var k = Math.round(Math.random() * 200 - 100);
                    a.data("repx", T);
                    a.data("repy", k);
                    a.data("repo", a.css("opacity"));
                    a.data("rotate", x);
                    a.data("scale", S);
                    a.transition({opacity: 0, scale: S, rotate: x, x: T, y: k, duration: "0ms"})
                } else {
                    if (r.ie || r.ie9) {
                    } else {
    ...
    function P(n, r) {
        ...
        if (r.slideamount > 1 && !(r.stopAfterLoops == 0 && r.stopAtSlide == 1)) {
            ...
            r.cdint = setInterval(function () {
                if (e("body").find(n).length == 0) D(n, r);
        ...
        revolution: function (i) {
            ...
            return this.each(function () {
                ...
                if (!o.hasClass("revslider-initialised")) {
                    ...
                    if (s.shuffle == "on") {
                        for (var g = 0; g < o.find(">ul:first-child >li").length; g++) {
                            var y = Math.round(Math.random() * o.find(">ul:first-child >li").length);
                            o.find(">ul:first-child >li:eq(" + y + ")").prependTo(o.find(">ul:first-child"))
                        }
                    }
                    s.slots = 4;
                    s.act = -1;
                    ...
                    if (b.length < 9) {
                        if (b.split("slide").length > 1) {
                            ...
                            if (w < 1) w = 1;
                            if (w > o.find(">ul:first >li").length) w = o.find(">ul:first >li").length;
                            s.next = w - 1
                        }
                    }
                    s.origcd = s.delay;
                    ...
                    if (s.lazyLoad != "on") {
                        o.waitForImages(function () {
                            ...
                            o.waitForImages(function () {
                                ...
                                setTimeout(function () {
                                    S(o, s);
                                    if (s.slideamount > 1) P(o, s);
                                    o.trigger("revolution.slide.onloaded")
                                }, 600)
                            })
                        })
                    } else {
                        var x = o.find("ul >li >img").first();
                        if (x.data("lazyload") != t) x.attr("src", x.data("lazyload"));
                        x.data("lazydone", 1);
                        x.parent().waitForImages(function () {
                            o.find("ul").css({display: "block"});
                            m(o, s);
                            if (s.slideamount > 1) l(o, s);
                            if (s.slideamount > 1) u(o, s);
